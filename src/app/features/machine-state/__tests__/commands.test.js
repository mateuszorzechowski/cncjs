...
describe('emergencyStop', () => {
  ...
  test('resets after the hold, not with it', () => {
    ...
    // The gap is the point. A reset sent in the same breath as the hold aborts
    // the motion planner while the axes are still decelerating, which is the
    // same as never having held at all — and that was the old behaviour this
    // replaced.
